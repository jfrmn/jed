...
static bool OnKeyDownEditMutiCursor(TextController* self, KeyEvent event) {
	...
	else if (event == keybinds.actions.moveToPrevWord) MoveToPrevWord(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.moveToNextWord) MoveToNextWord(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.moveToLineStart) MoveToLineStart(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.moveToLineEnd) MoveToLineEnd(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.moveToBufferStart) MoveToBufferStart(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.moveToBufferEnd) MoveToBufferEnd(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.movePageUp) MovePageUp(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.movePageDown) MovePageDown(self, &self->editCaretsPosition);
	else if (event == keybinds.actions.selectBackward) ActionShiftCaret(self, MoveBackward);
	else if (event == keybinds.actions.selectForward) ActionShiftCaret(self, MoveForward);
	else if (event == keybinds.actions.selectLineUp) ActionShiftCaret(self, MoveLineUp);
	else if (event == keybinds.actions.selectLineDown) ActionShiftCaret(self, MoveLineDown);
	else if (event == keybinds.actions.selectToNextWord) ActionShiftCaret(self, MoveToNextWord);
	else if (event == keybinds.actions.selectToPrevWord) ActionShiftCaret(self, MoveToPrevWord);
	else if (event == keybinds.actions.selectToLineStart) ActionShiftCaret(self, MoveToLineStart);
	else if (event == keybinds.actions.selectToLineEnd) ActionShiftCaret(self, MoveToLineEnd);
	else if (event == keybinds.actions.selectToBufferStart) ActionShiftCaret(self, MoveToBufferStart);
	else if (event == keybinds.actions.selectToBufferEnd) ActionShiftCaret(self, MoveToBufferEnd);
	else if (event == keybinds.actions.selectPageUp) ActionShiftCaret(self, MovePageUp);
	else if (event == keybinds.actions.selectPageDown) ActionShiftCaret(self, MovePageDown);
	else if (event == keybinds.actions.addCaretAbove) ActionGotoPrevCaret(self);
	else if (event == keybinds.actions.addCaretBelow) ActionGotoNextCaret(self);
	else if (event == keybinds.actions.editCarets) ActionLeaveEditMultiCaretMode(self);
	else return false;
...
bool TextController::OnKeyDown(KeyEvent event, /*out*/ TextChange** change) {
	...
	else if (event == keybinds.actions.moveToPrevWord) ActionMoveCaret(this, MoveToPrevWord);
	else if (event == keybinds.actions.moveToNextWord) ActionMoveCaret(this, MoveToNextWord);
	else if (event == keybinds.actions.moveToLineStart) ActionMoveCaret(this, MoveToLineStart);
	else if (event == keybinds.actions.moveToLineEnd) ActionMoveCaret(this, MoveToLineEnd);
	else if (event == keybinds.actions.moveToBufferStart) ActionMoveCaret(this, MoveToBufferStart);
	else if (event == keybinds.actions.moveToBufferEnd) ActionMoveCaret(this, MoveToBufferEnd);
	else if (event == keybinds.actions.movePageUp) ActionMoveCaret(this, MovePageUp);
	else if (event == keybinds.actions.movePageDown) ActionMoveCaret(this, MovePageDown);
	else if (event == keybinds.actions.selectBackward) ActionSelect(this, MoveBackward);
	else if (event == keybinds.actions.selectForward) ActionSelect(this, MoveForward);
	else if (event == keybinds.actions.selectLineUp) ActionSelect(this, MoveLineUp);
	else if (event == keybinds.actions.selectLineDown) ActionSelect(this, MoveLineDown);
	else if (event == keybinds.actions.selectToPrevWord) ActionSelect(this, MoveToPrevWord);
	else if (event == keybinds.actions.selectToNextWord) ActionSelect(this, MoveToNextWord);
	else if (event == keybinds.actions.selectToLineStart) ActionSelect(this, MoveToLineStart);
	else if (event == keybinds.actions.selectToLineEnd) ActionSelect(this, MoveToLineEnd);
	else if (event == keybinds.actions.selectToBufferStart) ActionSelect(this, MoveToBufferStart);
	else if (event == keybinds.actions.selectToBufferEnd) ActionSelect(this, MoveToBufferEnd);
	else if (event == keybinds.actions.selectPageUp) ActionSelect(this, MovePageUp);
	...
	else if (event == keybinds.actions.deletePrevWord) ActionDeleteLeft(this, change, MoveToPrevWord);
	else if (event == keybinds.actions.deleteNextWord) ActionDeleteRight(this, change, MoveToNextWord);
	else if (event == keybinds.actions.deleteLine) ActionDeleteLine(this, change);
	else if (event == keybinds.actions.indentLine) ActionIndentLine(this, change);
	else if (event == keybinds.actions.unindentLine) ActionUnindentLine(this, change);
	else if (event == keybinds.actions.insertTab) ActionInsertTab(this, change);
	else if (event == keybinds.actions.duplicateLine) ActionDuplicateLine(this, change);
	else if (event == keybinds.actions.undo) ActionUndo(this, change);
	else if (event == keybinds.actions.redo) ActionRedo(this, change);
	else if (event == keybinds.actions.cut) ActionCut(this, change);
	else if (event == keybinds.actions.copy) ActionCopy(this, change);
	else if (event == keybinds.actions.paste) ActionPaste(this, change);
	else if (event == keybinds.actions.cutLines) ActionCutLines(this, change);
	else if (event == keybinds.actions.lineComment) ActionLineComment(this, change);
	else if (event == keybinds.actions.lineUncomment) ActionUnLineComment(this, change);
	else if (event == keybinds.actions.blockComment) ActionBlockComment(this, change);
	else if (event == keybinds.actions.blockUncomment) ActionUnBlockComment(this, change);
	else if (event == keybinds.actions.addCaretAbove) ActionAddCaretAbove(this);
	else if (event == keybinds.actions.addCaretBelow) ActionAddCaretBelow(this);
	else if (event == keybinds.actions.editCarets) ActionEnterEditMultiCaretMode(this, true);
	else return false;
